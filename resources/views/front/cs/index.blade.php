    ...
    <div class="my-3 mx-3">
        ...
        <div class="col-lg-12 mb-5">
            <div class="text-center">
                <h1>Antrian CS</h1>
                <h1>{{ $min }}</h1>
                <a href="/cs" class="btn btn-danger btn-sm">refresh</a>
            </div>
        </div>
        <hr>
        ...
        <div class="row col-lg-12">
            <div class="col-lg-4">
                ...
                <p>Masukan nama dan nomor telepon untuk mendapatkan nomor antrian</p>
                    <form method="post" action="/store-cs">
                        @csrf
                        <input type="hidden" value="cs" name="layanan">
                        <div class="mb-3">
                        ...
                        <button type="submit" class="btn btn-danger">Dapatkan Antrian</button>
                    </form>
            </div>
            <div class="col-lg-8">
                <h4 class="text-center">Antrian CS</h4>
